...
do
        ...
        YYY=$(grep 'AAA'  ~/RASPA/simulations/share/raspa/forcefield/RBF_AlchemicalFF/force_field_mixing_rules.def | awk '{print $3}')
        ZZZ=$(grep 'BBB'  ~/RASPA/simulations/share/raspa/forcefield/RBF_AlchemicalFF/force_field_mixing_rules.def | awk '{print $4}')
        ...
        then
                ...
                sed -i 's/'${YYY}'/'${Epsilon}'/' ~/RASPA/simulations/share/raspa/forcefield/RBF_AlchemicalFF/force_field_mixing_rules.def
                sed -i 's/'${ZZZ}'/'${Siggma}'/' ~/RASPA/simulations/share/raspa/forcefield/RBF_AlchemicalFF/force_field_mixing_rules.def
                ...
                cd ~/RASPA/simulations/share/raspa/forcefield/RBF_Replacement/
                cp force_field_mixing_rules.def ../RBF_AlchemicalFF/
                cd -
